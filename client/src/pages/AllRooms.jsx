...
const AllRooms = () => {
    ...
    // Handel Change ffor filters and sorting
    ...
    // Function to CVheck if a room matches the Selected room types
    ...
    const filterDestination = (room) => {
        const destination = searchedParams.get('destination');
    ...
    const filterdRooms = useMemo(() => {
        return rooms
            ...
            .sort(sortRooms);
    }, [rooms, selectedFilters, selectedSort, searchedParams]);
